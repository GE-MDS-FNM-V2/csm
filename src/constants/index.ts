 ...
 * As is the browser is unable to make any type of calls to the radio, including JSON-RPC
 * calls with HTTP, due to CORS issues. We want to leave this here in case some protocols are
 * unblocked in the future.
 */
